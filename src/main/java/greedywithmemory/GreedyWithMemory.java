...
public class GreedyWithMemory {
    ...
    public GreedyWithMemory(Map map, Pair start, Pair end, boolean diagonals) {     //greedy który unika ścieżki po której już chodził
        this.map = map;
